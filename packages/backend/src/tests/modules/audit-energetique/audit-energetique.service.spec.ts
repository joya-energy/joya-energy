import { AuditSimulationService } from '../../../modules/audit-energetique/audit-energetique.service';
import type { AuditEnergetiqueCreateInput } from '../../../modules/audit-energetique/audit-energetique.service';
import { AuditEnergetiqueSimulationRepository } from '../../../modules/audit-energetique/audit-energetique.repository';
import { HTTP404Error } from '../../../errors/http.error';
...
describe('AuditSimulationService', () => {
  ...
  beforeEach(() => {
    ...
    // Setup mock implementations - use correct method names from CommonRepository
