...
auditEnergetiqueSimulationRoutes.post(
  '/send-pdf',
  async (req, res) => await auditReportController.sendAuditReport(req, res)
);
...
auditEnergetiqueSimulationRoutes.post(
  '/download-pdf',
  async (req, res) =>
    await auditReportController.generateAuditReportPDF(req, res)
);
...
auditEnergetiqueSimulationRoutes.post(
  '/send-pv-pdf',
  async (req, res) => await pvReportController.sendPVReport(req, res)
);
...
auditEnergetiqueSimulationRoutes.post(
  '/download-pv-pdf',
  async (req, res) => await pvReportController.downloadPVReportPDF(req, res)
);
