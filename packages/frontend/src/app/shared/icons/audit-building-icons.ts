...
export const BUILDING_CARD_CONFIG: BuildingCardConfig[] = [
  {
    ...
    label: BuildingTypes.CAFE_RESTAURANT,
    icon: 'lucideUtensilsCrossed',
  },
  { id: BuildingTypes.BEAUTY_CENTER, label: BuildingTypes.BEAUTY_CENTER, icon: 'lucideSparkles' },
  {
    id: BuildingTypes.HOTEL_GUESTHOUSE,
    label: BuildingTypes.HOTEL_GUESTHOUSE,
    icon: 'lucideHotel',
  },
  {
    id: BuildingTypes.CLINIC_MEDICAL,
    label: BuildingTypes.CLINIC_MEDICAL,
    icon: 'lucideStethoscope',
  },
  { id: BuildingTypes.SERVICE, label: BuildingTypes.SERVICE, icon: 'lucideBuilding2' },
  {
    id: BuildingTypes.OFFICE_ADMIN_BANK,
    label: BuildingTypes.OFFICE_ADMIN_BANK,
  ...
  {
    id: BuildingTypes.TEXTILE_PACKAGING,
    label: BuildingTypes.TEXTILE_PACKAGING,
    icon: 'lucideShirt',
  },
  { id: BuildingTypes.FOOD_INDUSTRY, label: BuildingTypes.FOOD_INDUSTRY, icon: 'lucideDrumstick' },
  {
    id: BuildingTypes.PLASTIC_INJECTION,
    label: BuildingTypes.PLASTIC_INJECTION,
    icon: 'lucideBox',
  },
  // { id: BuildingTypes.SERVICE, label: BuildingTypes.SERVICE, icon: 'lucideUtensilsCrossed' },
  {
    id: BuildingTypes.COLD_AGRO_INDUSTRY,
    label: BuildingTypes.COLD_AGRO_INDUSTRY,
    icon: 'lucideSnowflake',
  },
  {
    id: BuildingTypes.SCHOOL_TRAINING,
    label: BuildingTypes.SCHOOL_TRAINING,
